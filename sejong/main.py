...
object_detection_model_path = r'C:\workspace\Competition_no_git\sejong\datas\models\best_.pt'  # 객체 탐지 모델 파일 경로
segmentation_model_path = r'C:\workspace\Competition_no_git\sejong\datas\models\model_fold4_epoch33.pth'  # 도로 영역 분류 모델 파일 경로
...
def calculate_overlap(road_image_path, human_detection_path, output_folder):
    ...
    for detection in detections:
        ...
        elif np.sum(human_mask) / np.sum(road_label == 1) >= 0.2:  # 도로 영역과 40% 이상 겹치는 경우
